...
import { type User, type UserResponse } from "../interfaces.js";
...
router.post("/register", validateRegistration, async (req, res) => {
  try {
    ...
    const [result]: [ResultSetHeader, any] = await pool.execute("INSERT INTO users (username, email, password_hash) VALUES (?, ?, ?)", [username, email, hashedPassword]);
